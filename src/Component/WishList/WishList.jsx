                            ...
                            <ul className="flex flex-col divide-y dark:divide-gray-300">
                                <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
                                    <div className="md:flex w-full space-x-2 sm:space-x-4">
                                        <img className="mt-4 flex-shrink-0 object-cover w-30 h-35 dark:border- rounded outline-none sm:w-40 sm:h-56 dark:bg-gray-500" src={readboook.img} alt="book image" />
                                        <div className="flex flex-col justify-between w-full pl-0 md:pl-8 pb-4">

                                            <div className="space-y-1">
                                                <h3 className="text-4xl font-semibold leading-snug sm:pr-8">{readboook.book_name}</h3>
                                            ...
                                            <div className="flex gap-4">
                                                <div className="flex mt-6 mb-4">
                                                    ...
                                                    <h1 className=" pl-2 pr-2 pb-1 pt-1 bg-[#e8ffe5] text-[#23BE0A] rounded-3xl text-xl font-semibold mr-6">{readboook.tags[1]}</h1>
                                                </div>
                                                <div className="text-[#303030cc] font-medium text-lg flex gap-2">
                                                    <IoLocationOutline />
                                                    <p>Year of Publishing: {readboook.year_of_publishing}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex gap-6 align-middle mb-3">
                                                ...
                                                <div className="flex gap-4 text-[#303030cc] font-medium text-lg align-middle">
                                                    <MdOutlineFindInPage />
                                                    <p>Page: <span>{readboook.total_page}</span> </p>
                                                </div>
                                            </div>
                                            <hr />

                                            <div className="md:flex gap-4 mt-4">
                                                <p className="p-2 rounded-2xl bg-[#cddef3] text-lg font-medium text-[#328EFF] text-center">Category:{readboook.category}</p>
                                                <p className="mt-2 md:mt-0 p-2 rounded-2xl bg-[#f4e5cf] text-lg font-medium text-[#FFAC33] text-center">Rating:{readboook.rating}</p>
